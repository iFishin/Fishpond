...
<div class="">
    <div class="" id="main" role="main">
        <div class="container has-text-centered" style="position:relative; bottom:20vh">
            <h1 class="title is-2"><?php $this->archiveTitle([
        ...
        <?php else : ?>
            <article class="message">
                <div class="message-body"><?php _e('没有找到内容'); ?></div>
            </article>
        <?php endif; ?>
